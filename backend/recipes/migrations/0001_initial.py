# Generated by Django 2.2.16 on 2022-08-02 11:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(choices=[('#FF0000', 'Красный'), ('#FFA500', 'Оранжевый'), ('#FFFF00', 'Желтый'), ('#008000', 'Зеленый'), ('#0000FF', 'Синий'), ('#800080', 'Фиолетовый')], max_length=16, unique=True, verbose_name='Цвет по HEX-коду')),
                ('slug', models.SlugField(default='obed', max_length=200, unique=True, verbose_name='Уникальный слаг')),
            ],
            options={
                'verbose_name': 'Тег',
